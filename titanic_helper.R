...
generate.new.feature.binned.family <- function(titanic.data)
{
  titanic.data$binned.family <- '1'
  titanic.data$binned.family[titanic.data$family.size<5 & titanic.data$family.size>=2]  <- '2-4'
  titanic.data$binned.family[titanic.data$family.size>=5]  <- '> 4'
  titanic.data$binned.family <- as.factor(titanic.data$binned.family)
  return(titanic.data)
}
